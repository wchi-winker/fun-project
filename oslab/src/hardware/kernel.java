...
{
	/*系统基本信息*/
	public static int SINGLE_PAGE_SIZE=1024;	//每一页/块的大小
	public static int PAGE_COUNT=4; //每个进程分配的物理页
	public static int MEMORY_COUNT=16; //每个进程分配的物理页
	public static int MEMORY_SIZE=16*1024;	//内存大小，16KB
	...
	public static int PAGE_TABLE_LENGTH=kernel.MEMORY_USER_SPACE_SIZE/kernel.SINGLE_PAGE_SIZE;	//页表的长度，16

	public static int TLB_LENGTH=kernel.MEMORY_USER_SPACE_SIZE/kernel.SINGLE_PAGE_SIZE;	//TLB快表的长度，16
	/*系统基本信息*/
